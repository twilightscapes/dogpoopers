...
<StaticImage src="../../static/assets/dogpoopers-header-gift.webp" alt="Default Image" style={{height:'auto', maxHeight:'100vh', position:'relative', zIndex:'0', top:'0',border:'0px solid !important', objectFit:'cover', margin:'0 auto 2vh auto'}} />
...
<stripe-pricing-table pricing-table-id="prctbl_1PWaCSKHJvXfkmw3U2s2aCE5"
