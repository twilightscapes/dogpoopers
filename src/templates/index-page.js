...
<Link to='#plans' state={{modal: false}} className="print hover">
      <div className="button glow font" style={{ position: 'absolute', bottom: '1vh', right: '65px', background: '', padding: '1vh 1vw', display:'flex', alignItems:'center', borderRadius: '3px', opacity: '.9', zIndex: '', color:'#222', fontSize: 'clamp(1.3rem,1.5vw,3.2rem)', fontWeight:'900', zIndex:'1' }}>
    Pick Up My Poop!
      </div>
      </Link>
...
<li style={{display:'flex', alignItems:'center', gap:'10px'}}><span style={{fontSize:'2rem'}}>💩</span> Click the 'Yard Stick' button</li>
