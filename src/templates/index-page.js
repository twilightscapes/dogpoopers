...
-OR-
    <Link state={{modal: true}} to="xl-packages" className="button print" style={{ display: 'flex', justifyContent: 'center', padding:'1.5vh 1vw', maxWidth:'250px',fontSize:'130%' }}>3 or more</Link>
</div>
